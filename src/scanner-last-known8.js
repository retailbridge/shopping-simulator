...
export class ScannerSystem extends createSystem(
  ...
  private readonly gameDurationSeconds = 30; // changed from 60 to 30
  ...
  init() {
    ...
    this.setupToastPanel(); // our own canvas toast
  ...
  private showRoundComplete() {
    ...
    if (this.roundPanelEntity && this.roundPanelEntity.object3D) {
      ...
      // keep panel at anchorPos.y (eye-height)
