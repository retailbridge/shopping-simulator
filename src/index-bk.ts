...
World.create(document.getElementById("scene-container") as HTMLDivElement, {
  ...
  //
  // MENU PANEL – world-space menu next to the user (uses welcome.json)
  //
  ...
  //
  // PRODUCT PANEL – behind front plant, rotated to face the player
  //
  ...
  if (productPanelEntity.object3D) {
    // Place just behind the front plant
    productPanelEntity.object3D.position.set(0, 1.5, deskFrontZ - 0.5);
    // Face toward XR origin / user
    productPanelEntity.object3D.lookAt(0, 1.5, 0);
  }

  //
  // ROBOT – still on the left side of the desk cluster
  //
